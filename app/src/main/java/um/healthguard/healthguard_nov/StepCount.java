...
public class StepCount extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainToolbar = findViewById(R.id.step_toolbar);
...
//        totalsteps = findViewById(R.id.totalstep);
        todaysteps=findViewById(R.id.todaystep);
//        yesterdaysteps=findViewById(R.id.yesterdaystep);
...
//                                yesterdaysteps.setText(lastdaysteps+"");
//                                totalsteps.setText(accumulatesteps+"");
    ...
    public void onSensorChanged(SensorEvent event) {
        if(running){
            stepcounter++;
            currentsteps = 678 + stepcounter - accumulatesteps;
